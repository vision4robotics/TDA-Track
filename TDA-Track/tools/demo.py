...
parser = argparse.ArgumentParser(description='TDA-Track demo')
parser.add_argument('--config', type=str, default='../experiments/TDA-Track/config.yaml', help='config file')
parser.add_argument('--snapshot', type=str, default='./snapshot/tda-track.pth', help='model name')
